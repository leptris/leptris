...
per-document element index, and fused axis+predicate opcodes
(TODO 120, TODO 125–134). Numbers below are from
...
1.2-1.4× gap on bare wildcard descendant (`descendant::*`, `//*`)
is the per-element nodeset_add overhead in the VM result builder —
future work.
