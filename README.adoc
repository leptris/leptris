...
* XPath VM inline dispatch (replace evaluate_expr delegates with
  inline handlers for AXIS_STEP, BINARY_OP, FUNC_CALL).
* SAX function visibility fix (shared library export for Ruby SAX).
