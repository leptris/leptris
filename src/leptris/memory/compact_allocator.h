...
#ifndef LEPTRIS_COMPACT_ALLOCATOR_H
#define LEPTRIS_COMPACT_ALLOCATOR_H

#include <stddef.h>
#include "../leptris_internal.h"  /* LEPTRIS_API for the mirrored declaration */
#include <stdint.h>

/* No LeptrisStringView forward decl: nothing in this header references
...
#endif /* LEPTRIS_COMPACT_ALLOCATOR_H */
