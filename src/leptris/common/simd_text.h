 ...
 * runtime via leptris_cpu_detect().
 *
 ...
 */
#ifndef LEPTRIS_COMMON_SIMD_TEXT_H
#define LEPTRIS_COMMON_SIMD_TEXT_H
...
/* Shared classification table: leptris_dp_class_table[byte] is 0 for
...
extern unsigned char leptris_dp_class_table[256];

/* Idempotent one-time fill of the table (call before first use or
 * rely on leptris_text_scan_events to call it). */
...
#endif /* LEPTRIS_COMMON_SIMD_TEXT_H */
