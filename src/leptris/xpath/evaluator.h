...
/* If no public leptris/types.h was included earlier in this TU,
 * provide the public opaque-typedef set under the canonical guard
 * (matches leptris.h / dom/element.h).  Including the public header
...
/* ============================================================================
 * Types from leptris_internal.h
 * ============================================================================ */

/* XPathContext, XPathNodeSet, XPathResult are defined in leptris_internal.h */
 ...
 * pair per leptris_xpath_eval. Storage must outlive any pointers
 ...
 */
struct leptris_xpath_result* xpath_evaluate(XPathContext* context,
                                           XPathASTNode* ast);
