...
#ifndef LEPTRIS_DOM_COMPACT_H
#define LEPTRIS_DOM_COMPACT_H
...
#define LEPTRIS_COMPACT_ALIGNMENT 4
#define LEPTRIS_COMPACT_ALIGNMENT_LOG2 2

/* Special compact pointer values */
#define LEPTRIS_COMPACT_PTR_NULL       0    /* NULL pointer */
 ...
 */
typedef struct leptris_compact_header {
    uint8_t page_offset;   /* Offset from page_base in 4-byte units */
    uint8_t flags;         /* Node type flags (LEPTRIS_NODE_ELEMENT, etc.) */
} LeptrisCompactHeader;
 ...
 */
typedef struct leptris_compact_overflow_entry {
 ...
 */
typedef struct leptris_compact_overflow_table {
    LeptrisCompactOverflowEntry** buckets;
    size_t bucket_count;
    size_t entry_count;
    ...
    LeptrisCompactOverflowEntry* slab_next;  /* carve cursor */
    size_t slab_remaining;
} LeptrisCompactOverflowTable;
...
#define LEPTRIS_COMPACT_PTR8_OVERFLOW  INT8_MIN
#define LEPTRIS_COMPACT_PTR16_OVERFLOW INT16_MIN
 ...
 */
void leptris_compact_table_addref(void);
 ...
 */
void leptris_compact_table_release(void);
