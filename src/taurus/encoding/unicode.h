 ...
 * @param out_utf16 Output pointer for UTF-16 string (allocated, must free with taurus_utf16_free)
 ...
 *
 * Memory: Caller must call taurus_utf16_free() on the returned string
 */
 ...
 * @param out_utf8 Output pointer for UTF-8 string (allocated, must free with taurus_utf8_free)
 ...
 *
 * Memory: Caller must call taurus_utf8_free() on the returned string
 */
