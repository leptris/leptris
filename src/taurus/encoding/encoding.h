...
#ifndef TAURUS_ENCODING_H
#define TAURUS_ENCODING_H
 ...
 */
typedef enum {
    TAURUS_ENCODING_UTF8,
    TAURUS_ENCODING_UTF16LE,
    TAURUS_ENCODING_UTF16BE,
    TAURUS_ENCODING_UTF32LE,
    TAURUS_ENCODING_UTF32BE,
    TAURUS_ENCODING_ISO8859_1,
    TAURUS_ENCODING_ISO8859_2,
    TAURUS_ENCODING_ISO8859_15,
    TAURUS_ENCODING_WINDOWS_1252,
    TAURUS_ENCODING_SHIFT_JIS,
    TAURUS_ENCODING_EUC_JP,
    TAURUS_ENCODING_GB18030,
    TAURUS_ENCODING_EBCDIC_037,
    TAURUS_ENCODING_UNKNOWN
} taurus_encoding_t;
