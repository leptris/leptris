 ...
 */
#ifndef TAURUS_SAX_INTERNAL_H
#define TAURUS_SAX_INTERNAL_H
...
#ifndef TAURUS_SAX_MAX_DEPTH
#define TAURUS_SAX_MAX_DEPTH 256
#endif
...
struct TaurusSAXParser {
    ...
    /* Explicit element-name stack.  Bounded by TAURUS_SAX_MAX_DEPTH. */
    SaxElementFrame elem_stack[TAURUS_SAX_MAX_DEPTH];
    size_t elem_depth;
