...
Add `TAURUS_OPT_LEVEL` cache variable:
...
Add `TAURUS_TARGET_ARCH` cache variable:
...
libraries, which prevents inlining of `taurus_*` symbols across
...
- `-DTAURUS_OPT_LEVEL=aggressive`
- `-DTAURUS_TARGET_ARCH=native`
- `-DTAURUS_ENABLE_LTO=ON`
