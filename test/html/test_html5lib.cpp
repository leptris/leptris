...
TEST(Html5LibCorpus, TreeConstruction) {
     ...
     * 933 since in-head comments (928 initial-mode comments, 914
     * WHATWG character-reference decoding, 897 "in head noscript",
     * 887 frameset mode + structural-tag attributes, 859 tests19
     * insertion-mode edges, 792 in-table wrapper synthesis, 755
     * MathML/SVG foreign content, 652 <template> placement, 623
     * structural head/body, 556 DOCTYPE, 295 adoption agency, 294
     * foster, 285 two-mode split, 193 before it). */
    EXPECT_GE(passed, (size_t)933);
