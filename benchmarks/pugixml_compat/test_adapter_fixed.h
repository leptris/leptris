...
static inline xpath_node_set xpath_node_eval_string(xml_node node, const char* query) {
    ...
    /* We need a LeptrisDocument for xpath_eval, but we only have a node */
